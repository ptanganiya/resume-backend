...
import com.resume.exception.InvalidEmailIdException;
...
public class GlobalExceptionHandler {
	...
	public ResponseEntity<ApiResponse<ExceptionResponse>> handleInvalidEmailIdException(InvalidEmailIdException e)
	{
		return new ResponseEntity<ApiResponse<ExceptionResponse>>( new ApiResponse<>(HttpStatus.CONFLICT.value(),
				HttpStatus.CONFLICT.getReasonPhrase(), 
				new ExceptionResponse(e.getClass().getName(), "Email Id is not valid")), HttpStatus.CONFLICT);
